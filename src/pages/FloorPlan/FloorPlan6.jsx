...
import page1 from "../../assets/FloorPlan/FloorPlan6/unit_06.jpg"


const FloorPlan6 = () => {
	const menuContents = [
		{ title: "79㎡", url: "/FloorPlan/59A" },
		{ title: "84A㎡", url: "/FloorPlan/59B" },
		{ title: "84B㎡", url: "/FloorPlan/84A" },
		{ title: "84C㎡", url: "/FloorPlan/84A" },
		{ title: "84D㎡", url: "/FloorPlan/114A" },
    	{ title: "125㎡", url: "/FloorPlan/114B" },
	...
	return (
		<div className={styles.container}>
			...
			<div>평택의 새로운 주거 프리미엄</div>
			<div>평택역 더센트럴45를 만나보세요.</div>
			</div>
