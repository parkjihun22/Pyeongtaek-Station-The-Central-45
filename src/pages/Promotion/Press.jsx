...
export default function Press() {
  ...
  const seoPage = useMemo(
    () => ({
      ...
      description:
        "평택역 더센트럴45 언론보도 페이지입니다. 평택 고덕국제신도시 Abc-14BL·Abc-61BL 공급 정보, 청약, 입지환경, E-모델하우스와 방문예약 관련 공식 보도자료와 분양 소식을 확인하세요.",
      extraSchemas: [
        {
          "@context": "https://schema.org",
          "@type": "ItemList",
          "@id": `${getAbsoluteUrl(pressBasePath)}#press-list`,
          name: "평택역 더센트럴45 언론보도 목록",
        ...
        <section className={styles.pressHero} aria-labelledby="pressTitle">
          <div>
            ...
            <p className={styles.pressLead}>
              ...
              입지환경, E-모델하우스와 방문예약까지 평택역 더센트럴45의 공식
              보도자료와 분양 소식을 전합니다.
            </p>
          ...
          <div className={styles.pressStats} aria-label="평택역 더센트럴45 주요 정보">
            <div>
