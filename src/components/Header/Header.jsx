...
const T = {
  ...
  mainMenu: "주요 메뉴",
  logoAlt: "평택역 더센트럴45 로고",
  bannerAlt: "평택역 더센트럴45 방문예약 안내 배너",
};
...
const menuArray = [
  ...
  // },
  {
    title: "타입안내",
    subMenu: [
      { subTitle: "79㎡ ", subUrl: "/FloorPlan/59A" },
      { subTitle: "84㎡A", subUrl: "/FloorPlan/59B" },
      { subTitle: "84㎡B", subUrl: "/FloorPlan/84A" },
      { subTitle: "84㎡C", subUrl: "/FloorPlan/84B" },
      { subTitle: "84㎡D", subUrl: "/FloorPlan/114A" },
